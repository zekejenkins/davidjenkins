...
The regression model used to predict sales is as follows:

**Sales = 4.625 + 0.054 * TV + 0.107 * Radio + 0.000336 * Newspaper**
...
2. Consider reallocating budgets from Newspaper to TV and Radio based on the negligible impact of Newspaper advertising.
